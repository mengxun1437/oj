...
- [OJ系统后端API](#oj----api)
    ...
    + [一.教师](#---)
      - [1.1教师注册](#11----)
          + [注意：账号2-6位，密码6-20位](#-----2-6----6-20-)
          + [接口：[PUT]http://mengxun.online/api/oj/teacher/](#----put-http---mengxunonline-api-oj-teacher-)
          + [正确示例](#----)
          + [返回结果](#----)
          + [错误案例](#----)
          + [返回结果](#-----1)
      - [1.2教师登录](#12----)
          + [注意：账号2-6位，密码6-20位](#-----2-6----6-20--1)
          + [接口：[POST]http://mengxun.online/api/oj/teacher/](#----post-http---mengxunonline-api-oj-teacher-)
          + [正确示例](#-----1)
          + [返回结果](#-----2)
          + [错误示例](#----)
          + [返回结果](#-----3)
      - [1.3通过id获取教师的具体信息](#13--id---------)
          + [接口：[GET]http://mengxun.online/api/oj/teacher/{id}](#----get-http---mengxunonline-api-oj-teacher--id-)
          + [返回结果[正确]](#--------)
          + [返回结果[错误]](#--------)
      - [1.4修改教师的某些信息](#14---------)
          + [注意：账号2-6位，密码6-20位，性别{0,1}，年龄[10,60]](#-----2-6----6-20-----0-1-----10-60-)
          + [接口：[PATCH]http://mengxun.online/api/oj/teacher/{id}](#----patch-http---mengxunonline-api-oj-teacher--id-)
          + [正确示例：假设只需修改密码](#-------------)
          + [返回结果](#-----4)
          + [错误示例](#-----1)
          + [返回结果](#-----5)
    + [二.学生](#---)
      - [2.1学生注册](#21----)
          + [注意：账号2-6位，密码6-20位](#-----2-6----6-20--2)
          + [接口：[PUT]http://mengxun.online/api/oj/student/](#----put-http---mengxunonline-api-oj-student-)
          + [正确示例](#-----2)
          + [返回结果](#-----6)
          + [错误案例](#-----1)
          + [返回结果](#-----7)
      - [2.2学生登录](#22----)
          + [注意：账号2-6位，密码6-20位](#-----2-6----6-20--3)
          + [接口：[POST]http://mengxun.online/api/oj/student/](#----post-http---mengxunonline-api-oj-student-)
          + [正确示例](#-----3)
          + [返回结果](#-----8)
          + [错误示例](#-----2)
          + [返回结果](#-----9)
      - [2.3通过id获取学生的具体信息](#23--id---------)
          + [接口：[GET]http://mengxun.online/api/oj/student/{id}](#----get-http---mengxunonline-api-oj-student--id-)
          + [返回结果[正确]](#---------1)
          + [返回结果[错误]](#---------1)
      - [2.4修改学生的某些信息](#24---------)
          + [注意：账号2-6位，密码6-20位](#-----2-6----6-20--4)
          + [接口：[PATCH]http://mengxun.online/api/oj/student/{id}](#----patch-http---mengxunonline-api-oj-student--id-)
          + [正确示例：假设只需修改密码](#--------------1)
          + [返回结果](#-----10)
          + [错误示例](#-----3)
          + [返回结果](#-----11)
